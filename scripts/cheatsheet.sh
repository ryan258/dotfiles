...
echo ""
echo "--- AI STAFF HQ DISPATCHERS ---"
echo "  cat script.sh | dhp-tech       # Debug code (or: tech script.sh)"
echo "  dhp-creative 'story idea'      # Generate story package"
echo "  dhp-content 'blog topic'       # Create SEO-optimized guide"
echo "  <input> | dhp-strategy         # Strategic analysis"
echo "  dhp                            # Default to tech dispatcher"
echo ""
...
echo "  todo delegate <num> <type>     # Delegate task to AI"
...
echo ""
echo "  Full AI workforce: 42 specialists across 7 departments"
echo "  Setup: cp .env.example .env && add your OPENROUTER_API_KEY"
echo "  Docs: ~/dotfiles/bin/README.md"
echo ""
echo "--- DATA LOCATION ---"
