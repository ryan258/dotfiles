...
BLOG_FACTORY_HOME="${BLOG_FACTORY_HOME:-$PROJECTS_DIR/blog-factory}"
AI_STAFF_DIR="${AI_STAFF_DIR:-$DOTFILES_DIR/ai-staff-hq}"
OBSIDIAN_VAULT="${OBSIDIAN_VAULT:-$HOME/Documents/Obsidian/ryan-vault}"
OBSERVER_ENABLED="${OBSERVER_ENABLED:-true}"
OBSERVER_CAPTURE_COMMANDS="${OBSERVER_CAPTURE_COMMANDS:-true}"
