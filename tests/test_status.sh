...
setup() {
    ...
    # Copy core libraries
    for lib in common.sh config.sh date_utils.sh file_ops.sh spoon_budget.sh health_ops.sh github_ops.sh coach_ops.sh coach_metrics.sh coach_brief.sh coach_prompts.sh coach_scoring.sh coaching.sh focus_relevance.sh loader.sh; do
