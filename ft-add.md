...
- [x] Can start/stop timers on tasks
- [x] Accurate time tracking (tested with known durations)
- [x] Integrates with goodevening
...
- [x] Can track spoon budget and expenditure
- [ ] Predictions are reasonable (within ±3 of actual)
- [x] Integrates with startday/goodevening
...
- [x] Generates accurate summaries from real data
- [x] Multiple format outputs work correctly
- [x] All 10 tests passing
- [x] Takes <2 seconds to generate
...
- [x] Finds statistically significant correlations (p < 0.05)
...
- [x] Can read calendar events
- [x] Integrates with startday
...
_Note: User requested plan in `ft-add.md` in project root. This plan is in the system-designated location. After exiting plan mode, this can be copied to `ft-add.md` if desired._
